...
// Theme Swticher Base
jQuery('.theme-changer .theme-changer-icon').click(function(){

    if(jQuery('.theme-changer').hasClass("active")){
        jQuery('.theme-changer').animate({"left":"-113px"},function(){
            jQuery('.theme-changer').toggleClass("active");
        });                     
    }else{
        jQuery('.theme-changer').animate({"left":"0px"},function(){
            jQuery('.theme-changer').toggleClass("active");
        });         
    }
